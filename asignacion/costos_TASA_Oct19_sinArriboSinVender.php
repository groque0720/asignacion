...
function Header()
{
	if ($this->PageNo()==1) {
		...
		$this->Cell(150,5,utf8_decode('COSTOS UNIDADES TASA OCTUBRE 2019 - SIN ARRIBO SIN VENDER'),0,0,'C');
...
$pdf->SetAutoPageBreak(auto,5);
	...
	$SQL="SELECT * FROM view_asignaciones_costos_pagadas_oct_nolleg_sin_verder";
