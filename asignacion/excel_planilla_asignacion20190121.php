 ...
 if ($registros > 0) {
   ...
   $objPHPExcel->
    getProperties()
      ...
      $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('O1','Asesor')
            ->setCellValue('P1','Fec. Reserva')
            ->setCellValue('Q1','Confirmada');
   ...
   while ($registro = mysqli_fetch_object ($unidades)) {
      ...
      $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('N'.$i, $registro->cliente)
            ->setCellValue('O'.$i, $registro->asesor)
            ->setCellValue('P'.$i, cambiarFormatoFecha($registro->fec_reserva))
            ->setCellValue('Q'.$i, $estado_reserva);
      $i++;
   }
}
