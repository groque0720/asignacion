...
header('Content-Disposition: attachment;filename="AsignaciónPrecioJulio(AmarilloRayas)'.date("d-m-Y").'_'.date("H").date("i").date("s").'".xls"');
header('Cache-Control: max-age=0');
  ...
  //mysqli_query($con,"SET NAMES 'utf8'");
    ...
    $SQL="SELECT * FROM view_asignaciones_amarillas";
...
<table border="1">
    <thead>
        ...
        <tr>
            <td colspan="18" style="text-align: center;font-size: 16px; font-weight: bold;">Precio Julio (Amarillo Rayas)</td>
        </tr>
        <tr><td colspan="18"></td></tr>
