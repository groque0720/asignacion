...
header('Content-Disposition: attachment;filename="AsignaciónPreventaOct20(GrisRayas)'.date("d-m-Y").'_'.date("H").date("i").date("s").'".xls"');
...
<table border="1">
    <thead>
        ...
        <tr>
            <td colspan="18" style="text-align: center;font-size: 16px; font-weight: bold;">Preventa Octubre 2020 (Gris Rayas)</td>
        </tr>
        <tr><td colspan="18"></td></tr>
