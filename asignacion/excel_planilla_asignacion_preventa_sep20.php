...
header('Content-Disposition: attachment;filename="AsignaciónPreventaSep20(MarronRayas)'.date("d-m-Y").'_'.date("H").date("i").date("s").'".xls"');
...
<table border="1">
    <thead>
        ...
        <tr>
            <td colspan="18" style="text-align: center;font-size: 16px; font-weight: bold;">Preventa Septiembre 2020 (Marron Rayas)</td>
        </tr>
        <tr><td colspan="18"></td></tr>
