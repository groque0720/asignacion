...
header('Content-Disposition: attachment;filename="AsignaciónSinInternoConCosto'.date("d-m-Y").'_'.date("H").date("i").date("s").'".xls"');
header('Cache-Control: max-age=0');
  ...
  //mysqli_query($con,"SET NAMES 'utf8'");
    ...
    $SQL="SELECT * FROM view_asignaciones_sininterno_sincolor_concostos";
...
<table border="1">
    <thead>
        ...
        <tr>
            <td colspan="18" style="text-align: center;font-size: 16px; font-weight: bold;">Unidades del mes <?php echo nombre_del_mes(). ' '.date("Y") ?></td>
        </tr>
        <tr>
            <td colspan="18" style="text-align: center;font-size: 16px; font-weight: bold;">Unidades Sin interno y sin Colores condicionales</td>
        </tr>
        <tr><td colspan="18"></td></tr>
    ...
    <tbody>
        <?php while ($registro = mysqli_fetch_array($unidades)) { ?>
            ...
            <tr>
                ...
                <td style="text-align: center;"><?php echo number_format($registro['costo'], 2, ',', '.') ?></td>
