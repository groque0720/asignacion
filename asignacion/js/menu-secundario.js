	$(".item_link").click(function(event) {
		...
		if ($(this).attr('data-id')=='reservas_sin_sena') {
			$(".mod").show();
			nuevaUnidad='nuevaUnidad';
			$.ajax({
				url:"reservas_sin_sena.php",
				cache:false,
				type:"POST",
				data:{nuevaUnidad:nuevaUnidad},
				success:function(result){
		...
		if ($(this).attr('data-id')=='reservas_nro_unidad_duplicada') {
			$(".mod").show();
			nuevaUnidad='nuevaUnidad';
			$.ajax({
				url:"reservas_duplicadas_nrounidad.php",
				cache:false,
				type:"POST",
				data:{nuevaUnidad:nuevaUnidad},
				success:function(result){
		...
		if ($(this).attr('data-id')=='reservas_sin_nro_unidad') {
			$(".mod").show();
			nuevaUnidad='nuevaUnidad';
			$.ajax({
				url:"reservas_sin_nro_unidad.php",
				cache:false,
				type:"POST",
				data:{nuevaUnidad:nuevaUnidad},
				success:function(result){
		...
		if ($(this).attr('data-id')=='reservas_levantadas') {
			$(".mod").show();
			nuevaUnidad='nuevaUnidad';
			$.ajax({
				url:"reservas_unidades_levantadas.php",
				cache:false,
				type:"POST",
				data:{nuevaUnidad:nuevaUnidad},
				success:function(result){
