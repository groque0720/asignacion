	...
	<form class="form-unidad" action="" method="POST">
			...
			<div class="lado unidad-derecho cuadro">
				...
				<div class="form-linea centrar-texto">
					<div class="ancho-1-3 ">
						...
						<select class="form-inputs ancho-100 <?php echo $asesor_class; ?>" name="color_uno" id="color_uno">
							<option value="0"></option>
							<?php 
								for ($j=1; $j <= $i ; $j++) { ?>
				...
				<div class="form-linea centrar-texto">
					...
					<div class="ancho-1-3">
						...
						<input class="form-inputs input-fecha" type="date" size="5" id="fec_cancelacion" name="fec_cancelacion" value="<?php echo $unidad['fec_cancelacion']; ?>" <?php echo $lectura; ?>>
					</div>
				</div>
				...
				<div class="form-linea centrar-texto">
					<div class="ancho-1-3">
						...
						<input class="form-inputs input-fecha" type="date" size="5" id="fec_entrega" name="fec_entrega" value="<?php echo $unidad['fec_entrega']; ?>" <?php echo $lectura; ?>>
					</div>
					<div class="ancho-50">
						<label class="ancho-35" for="">Nro Remito</label>
						<input class="form-inputs" type="text" size="10" id="nro_remito" name="nro_remito" value="<?php echo $unidad['nro_remito']; ?>" <?php echo $lectura; ?>>
					</div>
		...
		<div class="zona-botones zona-entregas" <?php echo $visualizar; ?>>
			<div class="form-linea centrar-texto">
				...
				<?php 
					$SQL="SELECT * FROM entregas_ubicaciones WHERE activo = 1 AND id_sucursal=".$id_sucursal." ORDER BY ubicacion_entrega";
		...
		<div class="zona-botones">
			<div class="form-linea">
				...
				<div class="ancho-20 derecha-texto">
					...
					<?php if ($id_perfil==14 OR $id_perfil==5) { ?>
