 ...
 *
 * Reemplaza las ~12 consultas POR FILA del módulo viejo
...
if (!$rTot) { http_response_code(500); $salida = ["error"=>mysqli_error($con), "sql"=>$sqlTot]; return; }
...
if (!$rPage) { http_response_code(500); $salida = ["error"=>mysqli_error($con), "sql"=>$sqlPage]; return; }
