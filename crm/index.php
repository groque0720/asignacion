...
<head>
	<meta charset="UTF-8">
	<title>CRM - Derka y Vargas S. A.</title>
...
<!-- 	<script src="https://code.jquery.com/jquery-2.1.3.min.js"></script> -->
	...
	<link rel="stylesheet" href="css/estilo_form_prospectos.css">
...
<body>
	...
	<input type="hidden" id="lienzo_activos" value="0">
	<!-- Según el menu activo, funcionará según estee activo al iniciar la aplicación -->
	<input type="hidden" id="listado_activo" value="prospecto_formulario.php">
