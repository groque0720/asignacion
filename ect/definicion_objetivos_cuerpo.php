		...
		<tr class="<?php echo 'filas fila_'.$fila; ?>">
			...
			<?php 
				for ($i=0; $i < $cant_modelos; $i++) { 
					...
					?>
					<td class="centrar-texto"> <input data-id="<?php echo $objetivo['id']; ?>" data-nrofila="<?php echo $fila; ?>"  data-columna="<?php echo $i+3; ?>" data-fila="<?php echo 'fila_'.$fila; ?>" class="<?php echo $fila.'-'.$columna_celda.' cuadro-input derecha-texto'; ?>" type="text" value="<?php if ($objetivo['objetivo']!=0) { echo $objetivo['objetivo']; } ; ?>" size="2"></td>
			<?php } ?>
...
<script src="js/definicion_objetivos_cuerpo.js"></script>