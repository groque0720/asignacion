...
<div class="ancho-80 centrar-caja flexible" style="background: white; margin: auto; border-radius: 10px; ">
	...
	<div class="cuadro ancho-100" style="margin: 5px; border-radius: 10px; overflow: auto;border-color: #DDDDDD;">
	
		<div class="flexible">
			<div class="ancho-95 centrar-texto negrita margen-arriba-5"> Lista de Item - Aspectos a Mejorar ECT 5.0 </div>
		...
		<table class="margen-arriba-10 ancho-95">
			...
			<tbody>
			<?php 
				$SQL="SELECT * FROM ect_aspectos_mejorar_detalle WHERE activo = 1 ORDER BY detalle";
				...
				while ($pmi = mysqli_fetch_array($pmis)) { 
					...
					$SQL="SELECT * FROM ect_pmi_asesores_aspectos_mejorar WHERE id_asesor_ect = $id_asesor AND id_mes = $mes AND ano = $ano AND id_item =".$pmi['id'];
...
<script src="js/lista_check_aspectos_mejorar.js"></script>