...
<?php
	...
	$SQL="SELECT * FROM ect_pmi_asesores_aspectos_mejorar WHERE id_asesor_ect = $id_asesor AND id_mes = $mes AND ano = $ano";
...
<!-- 		<colgroup>
		...
		<?php 
			while ($pmi = mysqli_fetch_array($pmis)) { 
				...
				$SQL="SELECT * FROM ect_aspectos_mejorar_detalle WHERE id = ".$pmi['id_item'];
