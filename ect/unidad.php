			...
			<div class="lado unidad-derecho cuadro">
				...
				<div class="form-linea centrar-texto">
					<div class="ancho-1-3">
						...
						<input class="form-inputs input-fecha" type="date" size="5" id="fec_entrega" name="fec_entrega" value="<?php echo $unidad['fec_entrega']; ?>" <?php echo $solo_lectura; ?>>
					</div>
					<div class="ancho-50">
						<label class="ancho-35" for="">Nro Remito</label>
						<input class="form-inputs" type="text" size="10" id="nro_remito" name="nro_remito" value="<?php echo $unidad['nro_remito']; ?>" <?php echo $solo_lectura; ?>>
					</div>
