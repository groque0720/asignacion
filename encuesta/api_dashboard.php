...
function get_table(): array
{
    ...
    foreach ($rows as $r) {
        ...
        $acc_html = "<a href='resultado_detalle.php?id={$r['id_respuesta']}' class='btn-tbl btn-tbl-eye' title='Ver detalle'><i class='fa fa-eye'></i></a>"
                  . "<a href='resultado_pdf.php?id={$r['id_respuesta']}' class='btn-tbl btn-tbl-pdf' title='Ver PDF' target='_blank'><i class='fa fa-file-pdf'></i></a>";
        $data[] = [
            $r['fecha'],
