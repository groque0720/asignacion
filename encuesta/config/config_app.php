<?php
/*
 * Bootstrap del módulo Encuesta · 0km.
...
$tieneAcceso = in_array($perfil, ENCUESTA_PERFILES, true)
            || in_array($userId, ENCUESTA_USUARIOS_CONFIG, true);
...
$puedeConfigurar = in_array($perfil, [1, 14], true) || in_array($userId, ENCUESTA_USUARIOS_CONFIG, true);
