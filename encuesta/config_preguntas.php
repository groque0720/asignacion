...
<div class="enc-subpag-cabecera">
	...
	<a class="btn-enc btn-enc-azul btn-enc-sm" style="margin-left:auto;"
	   href="config_pregunta_form.php?id_encuesta=<?php echo $id_encuesta; ?>">
...
<?php if ($cant_preg == 0): ?>
	<div class="enc-form-panel" style="text-align:center;color:#888;padding:30px;">
		...
		<a href="config_pregunta_form.php?id_encuesta=<?php echo $id_encuesta; ?>" class="btn-enc btn-enc-azul" style="margin-top:10px;display:inline-block;">
	...
	<div class="enc-preg-item" id="preg-item-<?php echo $p['id_pregunta']; ?>">
		...
		<div class="enc-preg-acciones">
			...
			<a class="btn-enc btn-enc-azul btn-enc-sm"
			   href="config_pregunta_form.php?id_encuesta=<?php echo $id_encuesta; ?>&id=<?php echo $p['id_pregunta']; ?>">
...
$(function(){
	...
	$(document).on("click", ".btn-subir", function(){
		...
		mostrarCargando();
		$.post("config_pregunta_orden.php",
	...
	$(document).on("click", ".btn-baja-preg", function(){
		...
		swal({
			...
			mostrarCargando();
			$.post("config_pregunta_baja.php", {id_pregunta: id}, function(r){
				ocultarCargando();
