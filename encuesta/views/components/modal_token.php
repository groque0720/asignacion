    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md" @click.outside="modal.open = false">
      ...
      <div class="flex items-start justify-between px-5 py-4 border-b border-gray-100">
        <div class="min-w-0">
          ...
          <p class="text-xs text-slate-600 font-medium truncate" x-text="modal.cliente"></p>
          <p class="text-xs text-slate-400 truncate" x-text="modal.vehiculo"></p>
          <p class="text-[11px] text-slate-400 truncate">
            <span x-show="modal.chasis"><i class="fas fa-barcode mr-1"></i><span x-text="modal.chasis"></span></span>
            <span x-show="modal.chasis && modal.nro_orden"> · </span>
            <span x-show="modal.nro_orden"><i class="fas fa-hashtag mr-1"></i><span x-text="modal.nro_orden"></span></span>
          </p>
          <p class="text-[11px] text-slate-400 truncate">
            <span x-show="modal.asesor"><i class="fas fa-user-tie mr-1"></i><span x-text="modal.asesor"></span></span>
            <span x-show="modal.sucursal"> · <i class="fas fa-location-dot mr-1"></i><span x-text="modal.sucursal"></span></span>
