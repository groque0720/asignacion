/* Resultados · Dashboard de usados (Alpine + Chart.js + datalabels). */
function dashboardUsados() {
  return {
    loading: true,
    ...
    niveles: [],
    charts: {},
    filtros: { suc: 0, desde: '', hasta: '', asesor: '', anio: new Date().getFullYear(), mes: new Date().getMonth() + 1, area: 0 },
    sucursales: [
      { id: 0, nombre: 'Todas' }, { id: 1, nombre: 'Resistencia' },
      { id: 2, nombre: 'Sáenz Peña' }, { id: 3, nombre: 'Villa Ángela' }, { id: 4, nombre: 'Charata' },
    ],
    opciones: { anios: [new Date().getFullYear()], areas: [] },
    ...
    limpiar() { this.filtros = { suc: 0, desde: '', hasta: '', asesor: '', anio: new Date().getFullYear(), mes: new Date().getMonth() + 1, area: 0 }; this.load(); },
