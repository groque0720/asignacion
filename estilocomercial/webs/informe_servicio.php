...
<body class="desarroll">
	...
	<div class="ed-container web-80">
		...
		<div class="ed-item web-1-3 movil-50 centrar-texto">
			<h1>Informe Encuesta Servicio</h1>
		</div>
		...
		<div class="ed-item">
			<table class="tabla-default tabla-info">
				...
				<tbody>
					...
					<?php
						$SQL="SELECT * FROM encuestas_preguntas WHERE id_encuesta=3 AND activo =1 AND calcula_info=1";
					 ...
					 ?>
						...
						<?php
						$f = 0;
						while ($opcion = mysqli_fetch_array($preguntas_lineas)) { ?>
								<?php
