						...
						<?php 
							...
							$estado_primer_cliente = $cli['estado']; $class_cli='cliente-seleccionado cliente input-80';} else{$class_cli='cliente input-80';}?>
								...
								<div class="form-linea">
									...
									<span data-id="<?php echo $cli['id_cliente_gestoria']; ?>" data-estado="<?php echo $cli['estado']; ?>"  class="<?php echo $class_est_cli.' '.$cli['id_cliente_gestoria']; ?>"></span>
