...
$SQL="INSERT INTO sesiones (id_usuario, nombre, fecha, hora, latitud, longitud) VALUES (".$_SESSION["id"].",'".$_SESSION["usuario"]."','".date("Y-m-d")."','".date( 'H:i')."','".$longitud."','".$latitud."')";
mysqli_query($con, $SQL);



	if ($campo['idusuario'] == 91 or $campo['idusuario'] == 87 or $campo['idusuario'] == 15 or $campo['id_negocio'] == 2 or $campo['idusuario']==45 or $campo['idusuario']==41 or $campo['idusuario']==72 or $campo['idusuario']==79 or $campo['idusuario']==57 or $campo['idusuario']==71 or $campo['idusuario']==68 or $campo['idusuario']==59 or $campo['idusuario']==83 or $campo['idusuario']==11 or $campo['idusuario']==14 or $campo['idusuario']==82 or $campo['idusuario']==16 or $campo['idusuario']==60 or $campo['idusuario']==56 or $campo['idusuario']==63 or $campo['idusuario']==51 or $campo['idusuario']==36) {
	...
	if ($campo['idperfil']==24) {
	 ...
	 mysqli_close($con); 
		...
		$SQL="INSERT INTO sesiones (id_usuario, nombre, fecha, hora, latitud, longitud) VALUES (999,'NO EXITO - ".$usuario." - ".$contrasena."','".date("Y-m-d")."','".date( 'H:i')."','".$longitud."','".$latitud."')";
		mysqli_query($con, $SQL);
