...
<!-- 				<div class="flex justify-center mb-2 text-xs">
					...
					<span class="">No dar el precio, sin antes realizar la indagación de necesidades</span>
					<span class="text-red-600 font-bold mx-2"> &#x23; </span>
					<span class="">Cargar Presupuesto en Salesforce</span>
					<span class="text-red-600 font-bold mx-2"> &#x23; </span>
					<span class="">Envío de Material Digital</span>
					<span class="text-red-600 font-bold mx-2"> &#x23; </span>
					<span class="">Realizar Seguimiento 24 hs</span>
					<span class="text-red-600 font-bold mx-2"> &#x23; </span>
					<span class="">Envío de Material Digital</span>
				</div> -->
				<div class="p-2">
						...
						<div class="pl-6 text-gray-600">
							...
							<ul class="p-2">
								...
								<li class="p-2">En caso de contacto por Pagina Web:
									<ul class="p-2">
										<li><span class="text-red-600 font-bold">&#x2a; </span>Enviar material digital del producto de interés (Link Web, Ficha Técnica / Catálogo (Pdf) - WhatsApp Video - YouTube Video)</li>
										<li><span class="text-red-600 font-bold">&#x2a; </span>Mencionar que hay disponibilidad de realizar un Test Drive u ofrecer alguna alternativa de demostración de producto (fotos, videos llamadas, etc.)</li>
										...
										<li><span class="text-red-600 font-bold">&#x2a; </span>Detallar los datos comerciales del asesor. (Nombre, Teléfono, e-mail, etc.)</li>
									</ul></li>
							</ul>
						</div>
					</div>
					<div class="mb-3">
						...
						<div class="flex justify-center mt-3">
							<ul>
								<li><span class="text-red-600 font-bold">&#x2a; </span>Uso el vehículo</li>
					...
					<div class="mb-3">
						...
						<span class="text-lg font-bold">Presentación/Características del Producto</span>
						<div class="pl-6 text-gray-600">
							...
							<div class="mt-2 p-1 border  border-red-500 flex flex-col items-center justify-center">
								<p></span>En caso de consulta por Usados, <span class="text-red-500">MENCIONAR Y EXPLICAR EL PROGRAMA DE USADOS CERTIFICADOS.</span></p>
							</div>
							<div class="mt-2 p-1 border  border-red-500 flex flex-col items-center justify-center">
								...
								<p class="text-sm text-gray-600 italic">Ejemplos: Link web, ficha técnica / catálogo (Pdf) - WhatsApp video - Youtube video - envío de correo electrónico.</p>
							</div>
							<div>
						...
						<div class="pl-6 text-gray-600">
							...
							<div class="flex justify-center my-2">
									<ul>
										...
										<li><span class="text-red-600 font-bold">&#x2a; </span>Servicio GRATUITO DE REVISION a los 1000 km.</li>
										<li><span class="text-red-600 font-bold">&#x2a; </span>Etc.</li>
									</ul>
							</div>
					...
					<div class="mb-3">
						...
						<div class="pl-6 text-gray-600">
							<p><span class="font-bold">b) - </span>Ofrecer si o si, si no hay un modelo del interés del cliente mencionar que tenemos otros modelos que tiene la misma calidad del producto para que conozca.</p>
						</div>
					</div>
					<div class="mb-3">
						...
						<div class="pl-6 text-gray-600">
							<p><span class="font-bold">b) - </span>Se debe explicar al cliente <span class="font-bold">en detalle todo el proceso de venta</span>, desde el inicio o creación del boleto a la entrega del vehículo.</p>
						</div>
					</div>
					<div class="mb-3">
					...
					<div class="mb-3">
						...
						<span class="text-lg font-bold">Contacto Posterior - (Retención de clientes)</span>
						<div class="pl-6 text-gray-600">
							<p><span class="font-bold">a) - </span>El vendedor contacta al cliente dentro de los 7 días de la entrega del vehículo.. (por si surgió algún inconveniente y solucionar antes del contacto de TASA)</p>
						</div>
					</div>
				</div>
			</div>
