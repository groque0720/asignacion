			...
			<div class="w-full bg-indigo-50 p-2">
				...
				<div class="p-2">
					...
					<div class="mb-3">
						...
						<div class="pl-6 text-gray-600">
							<p><span class="font-bold">b) - </span>Ofrecer si o si, si no hay un modelo del interes del cliente mencionar que tenemos otros modelos que tiene la misma calidad del producto para que conozca.</p>
						</div>
					</div>
					<div class="mb-3">
