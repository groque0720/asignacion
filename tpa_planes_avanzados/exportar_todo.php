<?php
/*
 * Exportación Excel de TODOS los modelos de la situación (exportar_todo).
 * Wrapper auto-contenido: bootstrap moderno + consulta compartida + cuerpo PHPExcel
 * portado del módulo viejo (planes_avanzados/exportar_todo.php), sin cambios de formato.
 */
