	...
	$(document).ready(function(){
		...
		if ($("#idperfil").val()==1) {
 		...
 		$(".boton").click(function(event) {
			document.location.href ="../web/actualizar_precios.php";
			});
	...
	<section id="contenedor">
		...
		<article id="contenido">
			<div style="width:100%; overflow: hidden;">
				...
				<input type="button" class="boton" value="Actualizar Precio en Reservas" style="background:#7093DB; color:#fff; padding: 5px; border-radius: 5px;"/>
				</div>
			</div>
			<hr>
			<?php
