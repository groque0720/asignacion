...
$SQL="SELECT * FROM facturas_lineas WHERE movimiento=1 AND idfactura=".$factura['idfactura'];
$der=mysqli_query($con, $SQL);

$SQL="SELECT * FROM facturas_lineas WHERE movimiento=2 AND idfactura=".$factura['idfactura'];
$izq=mysqli_query($con, $SQL);

?>

<script src="../js/faturacion_editareliminar.js"></script>
