<?php
	...
	$SQL="SELECT reservas.*, clientes.nombre FROM
	 clientes INNER JOIN reservas ON clientes.idcliente = reservas.idcliente WHERE
	  reservas.anulada = 0 AND reservas.enviada >= 1  ORDER BY clientes.nombre LIMIT ".$_POST["inicio"]." , 15";
	  $res=mysqli_query($con, $SQL);
?>

<?php include("administracion_cuerpo.php") ?>
<span>Registros desde <?php echo $_POST["inicio"]+1;  ?> hasta <?php echo $_POST["inicio"] + 15;  ?>  </span>