...
<body>
	<div id="dialog" title="Derka y Vargas - Informa" style="text-align: center;">
		<p></p>
		<img src="../imagenes/logodyv.png"  width="250px" style="margin: 0 auto;">
...
<div id="agrupar">
		...
		<section id="seccion">
			...
			$SQL="SELECT * FROM reservas WHERE idusuario =".$_SESSION["id"]." AND not isnull(compra) AND anulada <> 1 AND entregada < 3  ORDER BY idreserva DESC LIMIT 15";
			$res=mysqli_query($con, $SQL);
			 ?>
			 <hr>
