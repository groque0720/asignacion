...
$SQL="SELECT * FROM facturas_lineas WHERE movimiento=1 AND idfactura='".$_POST['idfact']."'";
$der=mysqli_query($con, $SQL);

$SQL="SELECT * FROM facturas_lineas WHERE movimiento=2 AND idfactura='".$_POST['idfact']."'";
$izq=mysqli_query($con, $SQL);

  ?>
<script src="../js/facturacion_editareliminar.js"></script>
