...
<div id="detalle_fact">
	...
	<div id="encabezado">
				<div id="logos" style="border-bottom: 1px solid #ccc;">
					<img src="../imagenes/encabezado_fact.png" width="750px" height="40x">
				</div>
	...
	<div id="cliente">
				...
				<fieldset>
					...
					<div id="nom_fact">
						...
						<div id="ex_titular">
							<input value="Reserva realizada por : <?php echo $clientes['nombre']; ?>" size="120" style="border:none;">
						</div>
						...
						<div id="nuevo">
							...
							<div id="lineados">
								...
								<div id="interno" style="width:16%;">
									<label>Interno:</label>
									<input type="text" name="interno" id="interno" value="<?php echo $reserva["interno"] ?>" style="width:50%;" disabled>
								</div>
								<div id="nroorden" style="width:22%;">
									<label>Nro Orden:</label>
									<input type="text" name="nroorden" id="nroorden"  value="<?php echo $reserva["nroorden"] ?>" style="width:60%;" disabled>
								</div>
							</div>
