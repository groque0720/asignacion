...
<body>
	...
	<div class="sub_titulos">
		<h1>Reporte de Cancelaciones</h1>
	</div>
	...
	<div class="ventas">
		...
		<?php
			...
			<div class="sucursal">
				...
				Inner Join pagos_lineas ON reservas.idreserva = pagos_lineas.idreserva
				WHERE
				pagos_lineas.tipo = 3
				AND

				MONTH(pagos_lineas.fecha) =  MONTH(CURDATE())
				AND
				...
				<div class="det_suc_ase">
					...
					$SQL="SELECT
						...
						pagos_lineas.fecha as fec_can,
						pagos_lineas.tipo as tipo,
						reservas.interno as interno,
						reservas.internou as internou
						FROM
						reservas
						Inner Join clientes ON reservas.idcliente = clientes.idcliente
						Inner Join pagos_lineas ON pagos_lineas.idreserva = reservas.idreserva
						WHERE
						clientes.nombre <> ''
						AND
						MONTH(pagos_lineas.fecha) =  MONTH(CURDATE())
