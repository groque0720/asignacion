...
<!--     // <script language="javascript" src="../js/jquery-1.10.2.js"></script> -->
	...
	$(document).ready(function(){
		...
		// $('#nrounidad').change(function(event) {

		// nro_unidad= $(this).val();
		// $("#img_carga").show();
		// $.ajax({url:"reserva_bus_nrouni.php",
	 //       				cache:false,
	 //       				type:"POST",
	 //       				data:{nrouni:nro_unidad},
...
<body>
		...
		<section id="seccion">
			<div id="solicitud">
				...
				<form id="form_solicitud" name="form_solicitud" action="reserva_duplicar.php" method="POST" autocomplete="off">
					...
					<input type="submit" id="enviar_res_dup" name="enviar_res_dup" style="float:right; color:red;" value="Duplicar" size="30">
