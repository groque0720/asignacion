...
if ($_POST["enviado"] == 1 ) {
	...
	$SQL .=" VALUES (1,'".date("Y-m-d")."','$hora','".$not["idusuario"]."','".$_POST["compra"]."','".$_POST["nrores"]."','".$_POST["interno"].$_POST["internou"]."','".$modelo['modelo']."".$_POST["detalleu"]."','".$_POST["nombre"]."','".$_POST["usuario_a"]."',0,'".$_POST["observacion"]."')";
	mysqli_query($con, $SQL);
...
if ($_POST["enviado"] > 1) {
	...
	$SQL="SELECT usuarios.usuario as idusuario FROM reservas Inner Join usuarios ON reservas.idusuario = usuarios.idusuario WHERE reservas.idreserva = ".$_POST["nrores"];
	...
	$SQL="INSERT INTO notificaciones(tiponot, fechanot, hora, idusuario, compra, idreserva, interno, modelo, cliente, asesor, visto, obs )";
	$SQL .=" VALUES (2,'".date("Y-m-d")."','$hora','".$not["idusuario"]."','".$_POST["compra"]."','".$_POST["nrores"]."','".$_POST["interno"].$_POST["internou"]."','".$modelo['modelo']."".$_POST["detalleu"]."','".$_POST["nombre"]."','".$idudres["idusuario"]."',0,'".$_POST["obs_cambio"]."-".$_POST["observacion"]."')";
	mysqli_query($con, $SQL);
