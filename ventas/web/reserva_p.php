...
//--------------------------------------------------------------------------------------------------
	...
	$("#venta").change(function() {
		if ("Plan de Ahorro"==$(this).val()) {
			$("#mesentrega").removeAttr("required");
			$("#anoentrega").removeAttr("required");
		}else{
			$("#mesentrega").attr("required", "true");
			$("#mesentrega").attr("required", "true");
		}
	});
...
<body>
		...
		<section id="seccion">
			<div id="solicitud">
				...
				<form id="form_solicitud" name="form_solicitud" action="reserva_edit_p.php" method="POST" autocomplete="off">
