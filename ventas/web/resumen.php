	  	...
	  	$(document).ready(function(){
		  	...
		  	$("#busq").click(function(event) {
		  		...
		  		if ($("#fecha_buscar").val()!=null || $("#fecha_buscar").val()!=''  ) {
					...
					$.ajax({url:"resumen_buscar.php",cache:false,type:"POST",data:{abuscar:det },success:function(result){
...
<body>
	...
	WHERE fecres >= CURDATE() AND not isnull(compra) AND anulada <> 1 AND entregada < 3  ORDER BY idreserva";
